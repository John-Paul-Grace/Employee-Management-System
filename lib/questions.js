const questions = {
    ...
    // Ask for the employee's id. We use id because employee's could have the same name.
    askEmployeeId: {
        type: 'input',
        message: 'What is the employee\'s ID?',
        name: 'id'
    },
    // Ask which information to update and what to update to
    updateEmployee: [
        {
            type: 'list',
            message: 'Which employee info do you want to update?',
            name: 'column',
